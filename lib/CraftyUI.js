...
Crafty.c('UIOverlay', {
	...
	relativePlace: function (e, offx, offy) {
		this.screenSizeBound = false;
		this.screenx = e.screenx + offx;
		this.screeny = e.screeny + offy;
		this._moveWithViewport();
	},

	relativeCenter: function (e, offx, offy) {
		this.yBorder = e.yBorder;
		this.xBorder = e.xBorder;
		this.screenoffsetx = e.screenoffsetx + offx;
		this.screenoffsety = e.screenoffsety + offy;
		this.screenSizeBound = true;
		this._bindScreenPos();
	}
